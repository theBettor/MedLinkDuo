 ...
 */
public abstract class Hilt_PermissionActivity extends ComponentActivity implements GeneratedComponentManagerHolder {
  ...
  Hilt_PermissionActivity() {
    super();
    _initHiltInternal();
  }

  Hilt_PermissionActivity(int contentLayoutId) {
